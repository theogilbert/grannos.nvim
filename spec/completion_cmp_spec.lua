...
describe("completion.cmp", function()
  ...
  it("triggers on the union of every language's punctuation: '.' and ':' for a qualified column or a label, '{', '(', ',' and a quote for a selector, '$' for a Mongo operator", function()
